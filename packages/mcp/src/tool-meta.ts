...
export const TOOL_META = {
	...
	[T.getResumeAnalysis]: {
		...
		description: [
			...
			"Analyses are created from the TNM HR Platform web app AI flow, not from MCP.",
	...
	[T.importResume]: {
		title: "Import Resume",
		description: [
			"Create a new resume from a full ResumeData JSON object (e.g. an exported file from TNM HR Platform).",
