	...
	providers: {
		list: publicProcedure
			.route({
				...
				description:
					"Returns a list of all authentication providers enabled on this TNM HR Platform instance, along with their display names. Possible providers include password-based credentials, Google, GitHub, LinkedIn, and custom OAuth. No authentication required.",
