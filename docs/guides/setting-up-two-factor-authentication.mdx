...
description: "Enable TOTP two-factor authentication on your TNM HR Platform account with an authenticator app, save recovery codes, and manage 2FA settings."
---
