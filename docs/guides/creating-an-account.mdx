...
description: "Sign up for a TNM HR Platform account with email and password or social sign-in from Google or GitHub so you can start building and saving resumes."
---

<Steps>
  <Step title="Visit the homepage">
    Head over to [http://localhost:3000](http://localhost:3000) and click on the <Badge>Get Started</Badge> button.
  </Step>
  ...
  <Step title="Fill in your details">
    ...
    <Warning>
      Make sure to choose a username you're happy with, as it will be part of your public resume URL (e.g., `localhost:3000/your-username/resume-slug`).
    </Warning>

  </Step>
  
  <Step title="Sign up and log in">
    After filling in all the required fields, click the **Sign Up** button. You will be immediately logged in and can start using TNM HR Platform right away.
