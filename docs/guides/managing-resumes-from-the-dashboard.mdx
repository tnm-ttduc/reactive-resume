...
description: "Search, sort, filter, open, duplicate, lock, update, and delete resumes from the TNM HR Platform Resumes dashboard in grid or list view."
---
...
<Info>
  After you create or import a resume, TNM HR Platform opens it directly in the builder instead of returning you to the
  dashboard.
</Info>
