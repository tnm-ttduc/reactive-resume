...
description: "Register WebAuthn passkeys on your TNM HR Platform account to sign in with biometrics, a device PIN, or a security key instead of a password."
---
