...
description: "Create your first resume in TNM HR Platform by naming it, choosing a URL slug, and opening it in the builder to start filling in your details."
---

<Steps>
  <Step title="Log in to your account">
    Head over to [http://localhost:3000](http://localhost:3000) and log in with your account credentials.
...
<Step title="Click “Create a new resume”">
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `http://localhost:3000/{username}/{slug}`.
    </Warning>
