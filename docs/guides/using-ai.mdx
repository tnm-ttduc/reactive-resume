...
TNM HR Platform uses AI providers for features such as resume analysis, AI-assisted resume changes, AI agent drafts, and PDF or Word imports.

## Open AI provider settings

<Steps>
  <Step title="Sign in to the dashboard">
    Head over to [http://localhost:3000](http://localhost:3000) and sign in with your account credentials.
  </Step>
...
| **API Key** | The key TNM HR Platform should use when sending AI requests to that provider. |
...
Click **Save Provider** when the form is complete. TNM HR Platform tests the connection automatically as part of the save, so you'll see a success or failure status immediately without a separate click.
...
<Steps>
  <Step title="Click Test">
    TNM HR Platform sends a small request to verify the provider, model, base URL, and key.
  </Step>
  ...
  <Step title="Enable the provider">
    Turn on **Use** for the tested provider you want TNM HR Platform to use.
  </Step>
</Steps>
