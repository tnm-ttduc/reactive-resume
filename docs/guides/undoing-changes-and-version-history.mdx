...
description: "Undo and redo edits with keyboard shortcuts in the TNM HR Platform builder, and restore an earlier snapshot from the version history menu."
---

TNM HR Platform keeps two layers of change history for every resume:
...
TNM HR Platform automatically snapshots your resume at key moments:
...
<Steps>
  ...
  <Step title="Pick a snapshot">
    Select the entry you want to restore. TNM HR Platform asks you to confirm before replacing the current data.
  </Step>
