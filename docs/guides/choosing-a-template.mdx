...
description: "Compare the built-in TNM HR Platform templates, preview each layout, and switch between them from the builder to pick the best design for your resume."
---

TNM HR Platform offers a variety of unique templates, each with its own design aesthetic. This guide will help you understand the differences between templates and how to change your resume's template at any time.
...
TNM HR Platform includes a variety of professionally designed templates. Each template can be further customized with your choice of colors, fonts, and layout options.
