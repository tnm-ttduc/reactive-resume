...
Custom Styles do not accept raw CSS. TNM HR Platform renders final resumes through a PDF renderer, so Custom Styles use structured style rules that can be safely translated to PDF styles.
