...
description: "Move existing job applications into the TNM HR Platform Application Tracker by uploading a CSV file or pasting spreadsheet rows with headers."
---

Use CSV import when you already track applications in a spreadsheet and want to move them into TNM HR Platform.
...
<Steps>
  ...
  <Step title="Review the preview">
    TNM HR Platform shows how many rows are ready to import, which columns it recognized, and how many rows were skipped.
  </Step>
...
TNM HR Platform imports up to 500 applications at a time. If your CSV has more than 500 valid rows, split it into smaller files and import each file separately.
