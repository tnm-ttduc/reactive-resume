...
description: "Download your resume or cover letter from TNM HR Platform as PDF, DOCX, Markdown, or JSON, and pick the right format for each situation."
---

TNM HR Platform can export your resume, and your cover letter separately when you have one, in four formats.
...
| **JSON** | Backups, restoring a resume later, or importing into another TNM HR Platform account. |
...
- sharing a finished copy outside TNM HR Platform.
