...
description: "Start an isolated AI draft in the TNM HR Platform Agent workspace, chat with the agent, review proposed resume patches, and resume prior threads."
---
...
If you self-host TNM HR Platform, the agent workspace also requires the server-side agent configuration described in [Self-hosting with Docker](/self-hosting/docker).
