...
description: "Run TNM HR Platform as a self-hosted resume builder with Docker Compose, PostgreSQL, optional object storage, Single Sign-On, and v4 to v5 migration."
---

TNM HR Platform can be run as a self-hosted resume builder when you want to operate the app on your own infrastructure instead of using the hosted instance.
...
- TNM HR Platform application container.
- PostgreSQL database.
...
<Tip>
  Replace hosted URLs such as <code>http://localhost:3000</code> with your own instance URL when following API, MCP, or
  sharing examples.
</Tip>
