---
title: "Quickstart"
description: "Get started with TNM HR Platform in minutes by signing in to the hosted version or deploying your own self-hosted instance with Docker Compose."
---

## Options

TNM HR Platform offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use TNM HR Platform is through our cloud version at [localhost:3000](http://localhost:3000). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [localhost:3000](http://localhost:3000) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
For users who prefer complete control over their data, you can deploy TNM HR Platform on your own infrastructure using Docker.
...
<Steps>
	<Step title="Clone the Repository">
		```bash
		git clone https://github.com/your-organization/tnm-hr-platform
		cd tnm-hr-platform
		```
	</Step>
...
```
	...
	- **Redis** — Required for the AI Agent workspace
      ...
      - **TNM HR Platform** — The main application
    </Step>

    <Step title="Access Your Instance">
      Once all services are running, access your TNM HR Platform instance at:
...
| `tnm_hr_platform` | 3000 | The main TNM HR Platform application                 |

<Note>
  Saved AI provider management requires `ENCRYPTION_SECRET`, and the AI Agent workspace requires both `REDIS_URL` and
  `ENCRYPTION_SECRET`. Other TNM HR Platform features can run without them. Agent attachments and other private objects
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize TNM HR Platform.
  </Card>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/your-organization/tnm-hr-platform/issues) or reach out via
