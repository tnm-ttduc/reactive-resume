...
description: "Set up a local development environment for TNM HR Platform with pnpm, Docker services, environment variables, and the client, server, and worker apps."
---
...
This guide walks you through setting up TNM HR Platform for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local TNM HR Platform instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
TNM HR Platform uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to TNM HR Platform</Trans>;
```
